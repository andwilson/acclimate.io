...
import ZL from "../images/zl-portrait.jpg";
import AW from "../images/aw-portrait.jpg";
  ...
  <div>
    ...
    <SectionWrapper backgroundColor={colors.white} fontColor={colors.dark}>
      <div>
        ...
        <p>
          Some info about why we work well together as a team and what we believe
        </p>
      </div>
    </SectionWrapper>
...
export const pageQuery = graphql`
  query TeamQuery {
    zl: imageSharp(id: { regex: "/zl-portrait.jpg/" }) {
      sizes(maxWidth: 200) {
        ...GatsbyImageSharpSizes
      }
    }
    aw: imageSharp(id: { regex: "/aw-portrait.jpg/" }) {
      sizes(maxWidth: 200) {
        ...GatsbyImageSharpSizes
      }
    }
